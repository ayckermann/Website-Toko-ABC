<?php
$result = $this->model->selectBarang($kode_barang);
?>
<!DOCTYPE html>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="card" style="min-height:580px;">
                                            ...
                                            <div class="card-content table-responsive">
                                                ...
                                                <input type="hidden" name="gambarLama" id="gambarLama" value="<?php echo $result['gambar']; ?>">
                                                    <div class="form-floating mb-3">
                                                        <input style="background-color: #EEEEEE;" type="text" class="form-control" name="kode_barang" id="kode_barang" placeholder="Kode_barang" value="<?php echo $result['kode_barang']; ?>" readonly>
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input style="background-color: #EEEEEE;" type="number" class="form-control" name="harga" id="harga" placeholder="harga" value="<?php echo $result['harga']; ?>">
                                                        <label for="harga">Harga</label>
                                                    </div>  
                                                    <div class="form-floating mb-3">
                                                        <img src="img/<?php echo $result['gambar']; ?>" style="width:200px;">
                                                        <input style="background-color: #EEEEEE;" type="file" class="form-control" name="gambar" id="gambar" placeholder="gambar">
                                                        
                                                    </div>  
                                                    <div class="form-floating mb-3">
                                                        <input style="background-color: #EEEEEE;" type="number" class="form-control" name="jml_stok" id="jml_stok" placeholder="jml_stok" value="<?php echo $result['jml_stok']; ?>">
