                                            ...
                                            <div class="card-content table-responsive">
                                                <form ACTION="" METHOD="POST">
                                                    <div class="form-floating mb-3">
                                                        <input style="background-color: #EEEEEE;" type="text" class="form-control" name="kode_user" id="kode_user" placeholder="Kode User">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input style="background-color: #EEEEEE;" type="email" class="form-control" name="email" id="email" placeholder="Email">
                                                        <label for="email">Email</label>
                                                    </div>  
                                                    <div class="form-floating mb-3">
                                                        <input style="background-color: #EEEEEE;" type="number" class="form-control" name="telp" id="telp" placeholder="Telephone">
                                                        <label for="telp">Telephone</label>
                                                    </div>  
                                                    <div class="form-floating mb-3">
                                                        <input style="background-color: #EEEEEE;" type="password" class="form-control" name="password" id="password" placeholder="Password">
                                                        <label for="password">password</label>
                                                    </div>  
                                                    <div class="form-floating mb-1">
                                                        <input type="hidden" class="form-control" name="peran" id="peran" placeholder="Peran" value="guest">
                                                    </div>  
                                                    <div class="row pt-3">
