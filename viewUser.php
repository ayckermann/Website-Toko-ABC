                                        ...
                                        <div class="card" style="min-height:580px;">
                                            ...
                                            <div class="card-content table-responsive">
                                                <table class="table table-striped table-hover" style="border: 2px solid; color: grey;">
                                                    <thead>
                                                        <tr class="table-dark">
                                                            <th scope="col" style="text-align: center">Kode User</th>
                                                            <th scope="col">Nama</th>
                                                            <th scope="col">Email</th>
                                                            <th scope="col">Telpone</th>
                                                    ...
                                                    <tbody>
                                                        <tr class="table-light" >
                                                            <th scope="row" style="text-align: center; border: 1px solid;"><?= $row["kode_user"];?></th>
                                                            <td style="border: 1px solid;"><?= $row["nama"];?></td>
                                                            <td style="border: 1px solid;"><?= $row["email"];?></td>
                                                            <td style="border: 1px solid;"><?= $row["telp"];?></td>
                                                            <td style="border: 1px solid;"><?= $row["password"];?></td>
                                                            <td style="border: 1px solid;"><?= $row["peran"];?></td>
                                                            <?php if($_SESSION["peran"]==="Admin"): ?>
                                                                <td style="border: 1px solid; text-align: center;">
                                                                    <div class="btn-group">
                                                                        <a class="btn btn-dark" id="linktabuser1" href="?editUser=<?= $row["kode_user"];?>" >Edit</a>
                                                                        <a class="btn btn-dark" id="linktabuser2" href="?deleteUser=<?= $row["kode_user"];?>"
                                            ...
                                            <div class="d-grid gap-2 col-3 mx-auto">
                                                <a id="tombollogin" class="btn btn-lg btn-primary" href="?insert-user=" role="button">
                                                    Tambah User
                                                </a>
                                            </div>
                                        </div>
